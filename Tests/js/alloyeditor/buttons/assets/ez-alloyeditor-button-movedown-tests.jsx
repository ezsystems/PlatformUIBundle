 ...
 */
YUI.add('ez-alloyeditor-button-movedown-tests', function (Y) {
    ...
    defineTest = new Y.Test.Case({
        name: "eZ AlloyEditor movedown button define test",

        "Should register the movedown button": function () {
            Assert.areSame(
                Y.eZ.AlloyEditorButton.ButtonMoveDown,
                AlloyEditor.Buttons.ezmovedown,
                "The movedown button should be registered"
            );
        },
    });

    renderTest = new Y.Test.Case({
        name: "eZ AlloyEditor movedown button render test",
        ...
        "Should render a button": function () {
            ...
            button = ReactDOM.render(
                <Y.eZ.AlloyEditorButton.ButtonMoveDown editor={this.editor} />,
                this.container
            );
            ...
            Assert.areEqual(
                'move.down domain=onlineeditor', ReactDOM.findDOMNode(button).title,
    ...
    commandTest = new Y.Test.Case({
        name: "eZ AlloyEditor movedown command test",
        ...
        "Should execute the eZMoveDown command on click": function () {
            var button;
    ...
    Y.Test.Runner.setName("eZ AlloyEditor movedown button tests");
    Y.Test.Runner.add(defineTest);
    Y.Test.Runner.add(renderTest);
    Y.Test.Runner.add(commandTest);
}, '', {requires: ['test', 'node', 'node-event-simulate', 'ez-alloyeditor-button-movedown']});
