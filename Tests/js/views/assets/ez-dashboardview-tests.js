 ...
 */
YUI.add('ez-dashboardview-tests', function (Y) {
    var viewTest;

    viewTest = new Y.Test.Case({
        name: "eZ Dashboard View test",

        setUp: function () {
            this.view = new Y.eZ.DashboardView({container: '.container'});
        ...
        "Test iframe link": function () {
            ...
            iframeSource = this.view.get('container').one('.ez-dashboard-content').get('src');
    ...
    Y.Test.Runner.setName("eZ Dashboard View tests");
    Y.Test.Runner.add(viewTest);
}, '', {requires: ['test', 'ez-dashboardview']});
