...
YUI.add('ez-contenttypeeditserversideview', function (Y) {
    ...
    var events = {
        ...
        PROTOTYPE_UPDATE_REGEXP = /__number__/g,
        SPACE = 32, RETURN = 13;
    ...
    Y.eZ.ContentTypeEditServerSideView = Y.Base.create('contentTypeEditServerSideView', Y.eZ.ServerSideView, [], {
        ...
        /**
         * Count the number of options in the given Selection settings block.
         *
         * @method _countSelectionOptions
         * @private
         * @return {Number}
         */
        _countSelectionOptions: function (settingsNode) {
            return settingsNode.all('.ezselection-settings-option-value').size();
        },
        ...
        _createNewOptionNode: function (settingsNode) {
            var newOptionTpl = settingsNode.one('.' + SELECTION_PROTOTYPE_CLASS).get('text'),
                newOption;

            newOptionTpl = newOptionTpl.replace(PROTOTYPE_UPDATE_REGEXP, this._countSelectionOptions(settingsNode) + 1);
