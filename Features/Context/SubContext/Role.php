...
trait Role
{
    ...
    {
        $this->clickElementByText('Create', '.ez-button');
    }
    ...
    {
        $this->iSeeNotification('Invalid argument: The role name must be unique.');
    }
    ...
    public function iSeeRolesList(TableNode $roles, $button)
    {
        ...
        foreach ($roles as $role) {
            ...
            foreach ($elements as $element) {
                $foundName = $this->getElementByText($name, '.ez-role-name', null, $element);
                $foundButton = $this->getElementByText($button, '.ez-role-edit-button', null, $element);
                if ($foundName) {
                    break;
                }
            }
