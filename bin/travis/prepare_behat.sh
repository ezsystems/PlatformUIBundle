...
echo "> Updating packages (ezsystems/platform-ui-bundle:dev-tmp_travis_branch as 1.4)"
composer require --no-update "ezsystems/platform-ui-bundle:dev-tmp_travis_branch as 1.4"
